...
dynamicNews = dynamicNews.replace('<div className="pt-4 h-[450px] sm:h-[550px] lg:h-[650px] flex flex-col">', '<div className={cn("pt-4 flex flex-col", activeTab === "News" ? "h-[75vh]" : "h-[450px] sm:h-[550px] lg:h-[650px]")}>');
